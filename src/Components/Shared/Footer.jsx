...
//     <p>TaskSwift.<br/>Providing reliable Task management platform since 2022</p>
//   </aside> 
//   <div>
...
//   <div>
//     <p>Copyright © 2023 - All right reserved by TaskSwift </p>
//   </div>
// </div>
    ...
    return (
        <footer className="bg-gray-600">
            <div className="mx-auto max-w-5xl px-6 py-12 sm:px-6 lg:px-8">
                ...
                <p className="mx-auto mt-2 max-w-lg text-center leading-relaxed text-black">
                    Stay in Touch with TaskSwift!
                ...
                <ul className="mt-12 flex  justify-center gap-6 md:gap-8">
                    <a className="text-white rounded-lg cursor-pointer hover:text-gray-700" href="https://www.facebook.com/maimun407" target="blank">
                        <img src="https://i.ibb.co/w0ZjxMz/facebook.png" alt="" className="w-10 h-10" />
                    </a>
                    <a className="ml-3 text-white cursor-pointer hover:text-gray-700" href="https://www.instagram.com/maimun407" target="blank">
                        <img src="https://i.ibb.co/Rjk4dw2/instagram.png" alt="" className="w-10 h-10" />
                    </a>
                    <a className="ml-3 text-white cursor-pointer hover:text-gray-700" target="blank" href="https://www.linkedin.com/in/maimun54">
